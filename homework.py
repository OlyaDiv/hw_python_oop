...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        coeff_calorie_1 = 18
        coeff_calorie_2 = 20
        duration_in_mn = self.duration * 60
        result = (coeff_calorie_1 * self.get_mean_speed() - coeff_calorie_2) * self.weight / self.M_IN_KM * duration_in_mn
        return result
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        coeff_2 = 0.029
        duration_in_mn = self.duration * 60
        result = (coeff_1 * self.weight + (self.get_mean_speed() ** 2 // self.height) * coeff_2 * self.weight) * duration_in_mn
        return result 
